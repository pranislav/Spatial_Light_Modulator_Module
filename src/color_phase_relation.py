...
if __name__ == "__main__":
    ...
    parser.add_argument('-ss', '--subdomain_size', metavar="INT", type=int, default=64)
    parser.add_argument('-spp', '--samples_per_period', metavar="INT", type=int, default=16, help="number of phase shifts")
