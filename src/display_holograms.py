...
if __name__ == "__main__":
    ...
    parser.add_argument('-ct2pi', '--correspond_to2pi', metavar="INT", type=int, required=True, help="value of pixel corresponding to 2pi phase shift. you can change this parameter later by typing 'ct2pi <value>' in the console.")
