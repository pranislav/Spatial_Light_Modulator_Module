...
spacing_param_a = (
    2  # num of objects on x axis for grating or x coordinate for 1-object position
)
spacing_param_b = (
    2  # num of objects on y axis for grating or y coordinate for 1-object position
)
...
img = md.make_traps_image(coordinates, object, obj_size_x, obj_size_y)
